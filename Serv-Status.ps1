...
<#
    ...
    .EXAMPLE
    Serv-Status.ps1 -List C:\foo\servers.txt -O C:\foo -DiskAlert 90 -CpuAlert 95 -MemAlert 85 -Refresh 300 -Light
...
Do
{
    ...
    If ($csv)
    {
        $OutputFile = "$OutputPath\Serv-Status-Report.csv"
    ...
    Else
    {
        $OutputFile = "$OutputPath\Serv-Status-Report.htm"
    }
